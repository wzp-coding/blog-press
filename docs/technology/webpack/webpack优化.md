...
![图4-9-1 CDN 原理](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-9cdn-arch.png)
...
![图4-11 提取公共代码文件结构图](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-11%E6%8F%90%E5%8F%96%E5%85%AC%E5%85%B1%E4%BB%A3%E7%A0%81.png)
...
![图 4-15-1 Webpack Analyse 上传文件弹窗](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-15webpack-analyse-dialog.png)

Webpack Analyse 不会把你选择的 `stats.json` 文件发达到服务器，而是在浏览器本地解析，你不用担心自己的代码为此而泄露。 选择文件后，你马上就能如下的效果图：

![图 4-15-1 Webpack Analyse 主页](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-15webpack-analyse-home.png)
...
![图 4-15-1 Webpack Analyse Modules](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-15webpack-analyse-modules.png)

> 由于依赖了大量第三方模块，文件数量大，导致模块之间的依赖关系图太密集而无法看清，但你可以进一步放大查看。

点击 **Chunks**，查看代码块信息，效果图如下：

![图 4-15-2 Webpack Analyse Chunks](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-15webpack-analyse-chunks.png)

> 由代码块之间的依赖关系图可以看出两个页面级的代码块 `login` 和 `index` 依赖提取出来的公共代码块 `common`。

点击 **Assets**，查看输出的文件资源，效果图如下：

![图 4-15-3 Webpack Analyse Assets](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-15webpack-analyse-assets.png)

点击 **Hints**，查看输出过程中的耗时分布，效果图如下：

![图 4-15-3 Webpack Analyse Hints](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-15webpack-analyse-hints.png)
...
![图 4-15-4 Webpack Analyse Assets](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-15webpack-bundle-analyzer.png)
...
![图4.5.1 代理客户端发起 WebSocket 连接](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-5inline-client-websocket.png)
...
![图4.5.2 通过 iframe 自动刷新](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-5iframe-reload.png)
...
![图4.5.3 模块热替换模式下的补丁](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-6hot-patch.png)
...
![图4.5.4 模块热替换浏览器日志](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-6hmr-log.png)
...
![图4.5.4 现实出被替换模块的浏览器日志](https://gitee.com/wu_monkey/blog-images/raw/master/images/4-6hmr-log-named.png)
