...
![图5-1-1 监听模式的构建流程](../../.vuepress/public/images/5-1monitor.png)
...
![图5-5-1 设置断点](../../.vuepress/public/images/5-5breakpoint.png)

#### 2. 配置执行入口

告诉 Webstorm 如何启动 Webpack，由于 Webpack 实际上就是一个 Node.js 应用，因此需要新建一个 Node.js 类型的执行入口。

![图5-5-2 配置执行入口](../../.vuepress/public/images/5-5optionsentry.png)
...
![图5-5-3 启动 Webpack](../../.vuepress/public/images/5-5qidongwebpack.png)

#### 4. 执行到断点

启动后程序就会停在断点所在的位置，在这里你可以方便的查看变量当前的状态，找出问题，如图：

![图5-5-4 执行到断点](../../.vuepress/public/images/5-5execbreakpoint.png)
