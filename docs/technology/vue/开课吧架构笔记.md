...
> 和`$refs`有什么区别？// `$refs`是对象形式，`$chilren`是数组形式
...
例子：
![image-20210918141920946](https://blog-images-1302031947.cos.ap-guangzhou.myqcloud.com/images/image-20210918141920946.png)
